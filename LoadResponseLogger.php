    ...
    class LoadResponseLogger extends \ls\pluginmanager\PluginBase
    {
        ...
        protected function redirectToCopy($surveyId, $responseId)
        {
            ...
            $this->api->getRequest()->redirect($this->api->createUrl('survey/index', [
                'LoadResponseLogger' => $response->id,
                'sid' => $surveyId,
        ...
        public function beforeLoadResponse()
        {
            ...
            {
                $choice = $request->getParam('LoadResponseLogger');
                if (isset($choice)) {
                    if ($choice == 'new') {
                     ...
                     */
                    $_SESSION['LoadResponseLogger'] = isset($response) ? $response->id : $choice;
                } else {
            ...
            {
                if (isset($_SESSION['LoadResponseLogger']))
                {

                    $choice = $_SESSION['LoadResponseLogger'];
                    unset($_SESSION['LoadResponseLogger']);
                    if ($choice == 'new')
                    {
                        $this->event->set('response', false);
                    }
...
//                    'series' => $response->uoid,
                    ...
                    'urls' => [
                        ...
                        'update' => $this->api->createUrl('survey/index', array_merge($params, ['LoadResponseLogger' => $response->id])),
